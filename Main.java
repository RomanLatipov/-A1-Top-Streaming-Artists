...
public class Main {
   public static void main(String[] args) throws IOException {
    ...
    sc.close();
    //initiates the method for soring the array
    arr = arraySort(arr, arraySize, file);
   ...
   public static String[][] arraySort(String[][] arr, int arraySize, File file) throws IOException {
    Scanner sc = new Scanner(file);
    //skips the first 2 lines of the csv file bescase they are no important to the list
    sc.nextLine();
    sc.nextLine();
    ...
    //returns the array after it hase been ssorted
    return arr;
  }
}
